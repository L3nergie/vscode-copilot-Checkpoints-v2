...
exports.MSCodeViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fsExtra = __importStar(require("fs-extra"));
class MSCodeViewProvider {
    constructor(extensionUri, checkpointManager, outputChannel) {
    ...
    initialCheckpoints() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.updateWebviewContent(checkpoints); // Ajout d'une conversion de type
        });
    }
    refreshCheckpoints() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateWebviewContent(checkpoints) {
        if (this._view) {
        ...
        webviewView.webview.onDidReceiveMessage((message) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (message.command) {
                ...
                case 'showDiff':
                    ...
                    const checkpoint = this.checkpointManager.getCheckpointById(message.checkpointId); // Ajout d'une conversion de type
                    if (checkpoint && checkpoint.files[message.filePath]) {
                        const fileData = checkpoint.files[message.filePath];
                        if (fileData) {
                            const currentContent = yield this.getCurrentFileContent(message.filePath);
                ...
                case 'restoreCheckpoint':
                    ...
                    yield this.restoreCheckpoint(message.checkpointId);
                    break;
                case 'deleteCheckpoint':
                    this.outputChannel.appendLine(`Suppression du checkpoint: ${message.checkpointId}`);
                    yield this.deleteCheckpoint(message.checkpointId);
                    yield this.refreshCheckpoints();
                    break;
            }
        }));
    ...
    getCurrentFileContent(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const exists = yield fsExtra.pathExists(filePath);
                if (!exists) {
                    return '';
                }
                // Lire le contenu du fichier
                return yield fsExtra.readFile(filePath, 'utf8');
            }
            catch (error) {
    ...
    workspaceRoot(workspaceRoot, filePath) {
    ...
    restoreCheckpoint(checkpointId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.checkpointManager.restoreCheckpoint(checkpointId);
    ...
    deleteCheckpoint(checkpointId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.checkpointManager.deleteCheckpoint(checkpointId);
...
exports.MSCodeViewProvider = MSCodeViewProvider;
MSCodeViewProvider.viewType = 'mscode-sidebar';
//# sourceMappingURL=MSCodeViewProvider.js.map